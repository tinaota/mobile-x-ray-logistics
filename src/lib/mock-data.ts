import type { Order, Technician, Invoice, Specimen, SyncStatus } from "@/lib/utils";
...
export const MOCK_ORDERS: Order[] = [
  ...
  },
  {
    ...
    facilityName: "Central Lab - Level 2",
    address: "1001 E McDowell Rd, Phoenix, AZ",
    procedure: "STAT: Lactic Acid",
    cptCode: "83605",
    priority: "stat",
    status: "assigned",
  ...
  {
    id: "ORD-011",
    patientName: "Gloria Whitman",
    facilityName: "Valley View Nursing Home",
    address: "78 W Indian School Rd, Phoenix, AZ",
    procedure: "Lipid Panel (Fasting)",
    cptCode: "80061",
    priority: "routine",
    status: "in-transit",
    scheduledTime: "01:15 PM",
    distance: "5.0 mi",
    assignedTech: "L. Moreno",
    modality: "laboratory",
    fastingRequired: true,
    priorAuthNumber: "PA-87990-AZ",
  }
];

// ── Specimens (chain-of-custody records for laboratory orders) ────────────────

export const MOCK_SPECIMENS: Specimen[] = [
  {
    id: "spec-001",
    orderId: "ORD-011",
    accessionNumber: "LIPD-0011-1",
    specimenType: "SST",
    collectedAt: new Date(Date.now() - 35 * 60 * 1000).toISOString(),
...
export const MOCK_TECHNICIANS: Technician[] = [
  ...
  },
  {
    ...
    name: "M. Rivera",
    initials: "MR",
    licenseNumber: "PBT-AZ-31027",
    discipline: "phlebotomy",
    zone: "North District",
    activeOrders: 0,
    completedToday: 3,
    syncStatus: "synced",
